...
var main = function () { return __awaiter(_this$4, void 0, void 0, function () {
    var rawProjectFolder, projectFolder, projectName, isRouter, stateManagement, isDocker, ciService, cdService, generatorState;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 25:
                ...
                _a.label = 26;
            case 26:
                if (!(stateManagement === 'redux')) return [3 /*break*/, 28];
                return [4 /*yield*/, addRedux(generatorState)];
            case 27:
                _a.sent();
                _a.label = 28;
            case 28:
                if (!(stateManagement === 'apollo')) return [3 /*break*/, 30];
            ...
            case 31:
                ...
                logger.info(chalk.bold("Your new application lives in " + chalk.underline.green("./" + projectFolder)));
                return [2 /*return*/];
        }
    });
}); };
