...
var initReactApp = function (context) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, shell.execWithSpinner("npx create-react-app " + context.projectFolder + " --typescript", '[create react app] initialize')];
            case 1:
                _a.sent();
            ...
            case 5:
                _a.sent();
                return [4 /*yield*/, addDependencies('types and testing libraries', ['@types/styled-components', 'jest-styled-components', '@testing-library/react'], true)];
            case 6:
                _a.sent();
...
var addStylelint = function (context) { return __awaiter(void 0, void 0, void 0, function () {
    var lintCssNEXT, lintCssOther, lintCss, dependenciesShared, dependenciesMobile, dependenciesWeb, dependencies;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                lintCssNEXT = 'stylelint \'pages/**/*.{ts,tsx}\'';
                lintCssOther = 'stylelint \'**/*.{ts,tsx}\'';
                lintCss = context.projectType === ProjectType.NEXT ? lintCssNEXT : lintCssOther;
...
var addEslint = function (context) { return __awaiter(void 0, void 0, void 0, function () {
    var lintTsNEXT, lintTsOther, lintTs, dependenciesShared, dependenciesMobile, dependenciesWeb, dependencies;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                lintTsNEXT = 'eslint --ext .ts,.tsx pages';
                lintTsOther = 'eslint --ext .ts,.tsx src';
                lintTs = context.projectType === ProjectType.NEXT ? lintTsNEXT : lintTsOther;
                dependenciesShared = ['eslint', 'eslint-plugin-import', '@code-quality/eslint-config-typescript', 'eslint-config-prettier'];
...
var initReactNativeApp = function (context) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, shell.execWithSpinner("npx react-native init " + context.projectFolder, '[react-native-app] initialized')];
            case 1:
                _a.sent();
