    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)('git add .', 'New files were added to git')];
            case 1:
                _a.sent();
                return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)('git commit -m "feat: bootstrap application"', 'Changes were checked to version control.')];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
var initializeCreateReactApp = function (state) { return __awaiter(_this$3, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, shell.execWithSpinner("npx create-react-app " + state.projectFolder + " --typescript", 'Create React App initialized')];
            case 1:
                _a.sent();
                return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)("yarn remove @types/jest @types/node @types/react @types/react-dom && yarn add @types/jest @types/node @types/react @types/react-dom -D", '@types moved to devDependencies')];
            case 2:
                _a.sent();
                return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)("yarn add @types/webpack-env -D", '@types/webpack-env installed')];
            case 3:
                _a.sent();
...
var addPrettier = function (state) { return __awaiter(_this$3, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)('yarn add prettier -D', 'prettier installed')];
            case 2:
                _a.sent();
...
var addStyleLint = function (state) { return __awaiter(_this$3, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)('yarn add stylelint @strv/stylelint-config-styled-components stylelint-config-prettier -D', 'stylelint installed')];
            case 2:
                _a.sent();
...
var addEslint = function (state) { return __awaiter(_this$3, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)('yarn add eslint @strv/eslint-config-react @strv/eslint-config-typescript @strv/stylelint-config-styled-components @typescript-eslint/parser eslint-config-prettier eslint-plugin-react-hooks -D', 'eslint installed')];
            case 2:
                _a.sent();
...
var addGitHooks = function (state) { return __awaiter(_this$3, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)('yarn add husky lint-staged @commitlint/cli @commitlint/config-conventional -D', 'eslint installed')];
            case 1:
                _a.sent();
...
var addBasicProjectFiles = function (state) { return __awaiter(_this$3, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)('rm -r src/*', 'Old project structure removed')];
            case 1:
                _a.sent();
                return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)('yarn add styled-components && yarn add @types/styled-components jest-styled-components @testing-library/react -D', 'Essential libraries installed')];
            case 2:
                _a.sent();
...
var addReactRouter = function (state) { return __awaiter(_this$3, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)('yarn add react-router react-router-dom && yarn add @types/react-router-dom -D', 'React Router installed')];
            case 1:
                _a.sent();
...
var addRedux = function (state) { return __awaiter(_this$3, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)('yarn add redux react-redux && yarn add @types/redux @types/react-redux -D', 'Redux installed')];
            case 1:
                _a.sent();
...
var addApollo = function (state) { return __awaiter(_this$3, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)('yarn add apollo-boost react-apollo graphql', 'Apollo installed')];
            case 1:
                _a.sent();
...
var addHerokuConfig = function (state) { return __awaiter(_this$3, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)('yarn add serve', 'serve server added')];
            case 1:
                _a.sent();
...
var main = function () { return __awaiter(_this$4, void 0, void 0, function () {
    var projectFolder, projectName, isRouter, stateManagementType, isDocker, ciService, cdService, generatorState;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                projectFolder = (_a.sent()).projectFolder;
                projectName = words.toCapitalized(projectFolder);
                return [4 /*yield*/, inquirer.prompt({
                        name: 'isRouter',
                        type: 'list',
