        ...
        switch (_b.label) {
            ...
            case 5:
                ...
                return [4 /*yield*/, json.update('package.json')({
                    ...
                    }, function (jsonFile) { return (__assign(__assign({}, jsonFile), { scripts: __assign(__assign({}, jsonFile.scripts), { 'detox:ios': 'detox test -c ios.sim.debug', 'detox:ios:build': 'detox build -c ios.sim.debug', 'detox:android': 'detox test -c android.emu.release', 'detox:android:build': 'detox build -c android.emu.release' }), detox: {
                            configurations: {
                                'ios.sim.debug': {
