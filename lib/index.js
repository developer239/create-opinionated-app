...
var addBasicProjectFiles = function (state) { return __awaiter(_this$3, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, shell.execInProjectWithSpinner(state.projectFolder)('yarn add react-router react-router-dom styled-components && yarn add @types/react-router-dom @types/styled-components jest-styled-components @testing-library/react -D', 'Essential libraries installed')];
            case 2:
                _a.sent();
...
var main = function () { return __awaiter(_this$4, void 0, void 0, function () {
    var projectFolder, projectName, isDocker, ciService, cdService, generatorState;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 9:
                _a.sent();
                if (!(ciService === 'circleCi')) return [3 /*break*/, 11];
                return [4 /*yield*/, addCircleCiConfig(generatorState)];
            case 10:
                _a.sent();
                _a.label = 11;
            case 11:
                if (!(cdService === 'heroku')) return [3 /*break*/, 13];
                return [4 /*yield*/, addHerokuConfig(generatorState)];
            case 12:
                _a.sent();
                _a.label = 13;
            case 13:
                if (!isDocker) return [3 /*break*/, 15];
                return [4 /*yield*/, addDocker(generatorState)];
            case 14:
                _a.sent();
                _a.label = 15;
            case 15: return [4 /*yield*/, addEditorConfig(generatorState)];
            case 16:
                _a.sent();
            ...
            case 22:
                _a.sent();
                return [4 /*yield*/, addFilesToGit(generatorState)];
            case 23:
                _a.sent();
                return [2 /*return*/];
        }
