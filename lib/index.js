    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, shell.execWithSpinner("npx react-native init " + context.projectFolder, '[react-native-app] initialized')];
            case 2:
                _b.sent();
            ...
            case 10:
                ...
                return [3 /*break*/, 14];
            case 11: return [4 /*yield*/, addDependencies('react-navigation', ['react-navigation', 'react-native-reanimated', 'react-native-gesture-handler', 'react-native-screens', 'react-native-safe-area-context', 'react-navigation-tabs'])];
            case 12:
                _b.sent();
                return [4 /*yield*/, generate({
                        name: moduleName$8,
            ...
            case 13:
                _b.sent();
                return [3 /*break*/, 14];
            case 14: return [4 /*yield*/, shell.execInProjectWithSpinner(context.projectFolder)('react-native link', 'linked RN dependencies')];
            case 15:
                _b.sent();
                return [4 /*yield*/, shell.execInProjectWithSpinner(context.projectFolder)('cd ios && pod install', 'installed pod files')];
            case 16:
                _b.sent();
                return [2 /*return*/];
        }
