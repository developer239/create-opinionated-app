...
var execWithSpinner = function (command, successMessage) { return __awaiter(_this, void 0, void 0, function () {
...
var installNpx = function () { return __awaiter(_this$1, void 0, void 0, function () {
    var code;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var initializeCreateReactApp = function () { return __awaiter(_this$1, void 0, void 0, function () {
    var projectName;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, shell.execWithSpinner("npx create-react-app " + projectName, 'Create React App initialized')];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
