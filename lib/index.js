    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                ...
                _a = projectType;
                switch (_a) {
                    case ProjectType.GATSBY: return [3 /*break*/, 5];
                    case ProjectType.CRA: return [3 /*break*/, 7];
                    case ProjectType.NEXT: return [3 /*break*/, 9];
                    case ProjectType.RN: return [3 /*break*/, 11];
                    case ProjectType.NEST: return [3 /*break*/, 13];
                }
                return [3 /*break*/, 15];
            case 5:
